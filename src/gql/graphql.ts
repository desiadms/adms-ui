...
export type Mutation_Root = {
  ...
  update_usersMetadata_many?: Maybe<
    Array<Maybe<UsersMetadata_Mutation_Response>>
  >
...
export type UserQuery = {
  ...
  usersMetadata: Array<{
    ...
    usersMetadata_user: { __typename?: 'users'; email?: any | null }
  }>
}
...
export type UpdateUserMutation = {
  __typename?: 'mutation_root'
  update_usersMetadata_by_pk?: { __typename?: 'usersMetadata'; id: any } | null
}
...
export type AllTasksQuery = {
  ...
  tasks: Array<{
    ...
    tasks_images: Array<{ __typename?: 'images'; id: any; task_id: any }>
  }>
}
...
export type TasksMutation = {
  ...
  insert_images?: {
    __typename?: 'images_mutation_response'
    returning: Array<{ __typename?: 'images'; id: any; task_id: any }>
  } | null
}
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'usersMetadata' },
            arguments: [
              {
                kind: 'Argument',
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'role_field_supervisor' }
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'role_filed_monitor' }
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'role_operations_manager' }
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'role_pc_admin' }
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'role_project_manager' }
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'usersMetadata_user' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'update_usersMetadata_by_pk' },
            arguments: [
              {
                kind: 'Argument',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'contractor' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'sub_contractor' }
                },
                { kind: 'Field', name: { kind: 'Name', value: 'location' } },
                { kind: 'Field', name: { kind: 'Name', value: 'poc' } }
              ]
            }
          }
        ]
  ...
  definitions: [
    {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                ...
                type: {
                  kind: 'NamedType',
                  name: { kind: 'Name', value: 'tasks_insert_input' }
                }
              }
            }
          }
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'insert_images' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'objects' },
...
} as unknown as DocumentNode<TasksMutation, TasksMutationVariables>
